...
Goto Administrator > Modules page and install the module as any other drupal module.

2. Configuration:
=================
Administrator > Social Block > Amazon Send to Kindle Integration

In the configuration for you can select the content type for which you want to display the send to kindle button. 
...
Click on Generate widget code button and you will be given javascript code and html code.
